    ...
    <section className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-2">
        ...
        <div className="lg:py-4">
          ...
          <p className="mt-6 text-2xl font-bold">{formatRupiah(item.price)}</p>
          {item.available ? (
            <div className="mt-8 space-y-6">
              ...
              >
                <ShoppingBag size={19} /> Tambah ke Keranjang
              </button>
              {added && (
                <p
                  role="status"
                  className="flex items-center justify-center gap-2 font-semibold text-emerald-700"
                >
                  <CheckCircle2 size={18} /> Berhasil ditambahkan ke keranjang
                </p>
              )}
            </div>
          ) : (
